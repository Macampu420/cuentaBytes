...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2023 a las 06:24:40
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarCompra` (IN `_idCompra` INT(11))   SELECT enccompraproducto.idCompra, enccompraproducto.fechaCompra, enccompraproducto.vrTotalCompra, enccompraproducto.vrTotalIva, 
...
(9, '2023-04-28 04:24:17', 16, 20000);
...
(22, '2023-04-28 03:31:08', 0, 1, 35000, 10),
(23, '2023-04-28 03:57:26', 0, 2, 17500, 14);
...
(1, 'Vino gato negro', 'Vino Tinto merlot 2020', 42000, 50000, 100, 21),
(2, 'Crema de whiskey', 'Crema dulce', 30000, 42000, 100, 20),
(3, 'Pilsenon litro', 'Cerveza pilsen litro', 3000, 5500, 99, 19),
(4, 'Pilsenon 750', 'Pilsenon 750ml\r\n', 2500, 5000, 100, 18),
(5, 'Media de guaro', 'Media de guaro tapa roja', 25000, 20000, 100, 9),
(6, 'litro de ron caldas', 'Litro de ron caldas', 40000, 50000, 100, 17),
(7, 'Aguilon litro', 'Aguilon litro', 5000, 6000, 98, 16),
(8, 'Vino Vientos del sur', 'Cavernet vientos del sur 750ml', 25000, 36000, 100, 15),
(9, 'Botella de champaña', 'Botella de champaña blanca, espumosa ', 30000, 50000, 100, 14),
(10, 'Botella de gin', 'Botella de ginebra ', 40000, 55000, 100, 13),
(11, 'Aguila lata', 'Lata de aguila negra 330cm3', 2000, 3500, 0, 12),
(12, 'Botella de vodka', 'botella de vodka smirnoff', 40000, 50000, 100, 11);
...
--
ALTER TABLE `detalleventa`
  MODIFY `idDetVenta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT de la tabla `detcompraproducto`
--
ALTER TABLE `detcompraproducto`
  MODIFY `idDetCompra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
