<div class="modal" id="modalEgresos" tabindex="-1" editar="false">
        ...
        <div class="modal-content text-dark" style="background-color: #A0D2D8;">
            <div class="modal-body pb-lg-5 px-lg-5 mx-3">
                <form>
                    ...
                    <h1 class="text-center mt-3 questrial">Registrar egreso</h1>


                    <div class="row p-2 mb-5">
                        <div class="col-6 mx-auto col-lg-3">
                            <label for="inpFecha" class="form-label quicksand">Fecha:</label>
                            <input required type="date" class="form-control" id="inpFecha" aria-describedby="basic-addon3">
                        </div>
                        <div class="col-6 mt-3 mt-md-0 mx-auto col-lg-3">
                            <label for="inpFecha" class="form-label quicksand">Titulo:</label>
                            <input required type="text" class="form-control" id="inpTitulo" aria-describedby="basic-addon3">
                        </div>
                        <div class="col-6 mt-3 mt-md-0 mx-auto col-lg-3">
                            <label for="inpFecha" class="form-label quicksand">Tipo egreso:</label>
                            <select required id="slcTipoEgreso" class="form-select" aria-label="Default select example"></select>
                        </div>
                    </div>

                    <div id="btnAnadir" class="row mb-3">
                        <h3 class="my-auto mx-auto col-10 col-lg-4 p-0 quicksand"><img src="../../public/img/iconoMas.png" class="">
                            Añadir item</h3>
                    </div>

                    <div id="contItems" class="border border-white border-3 rounded px-4 py-2 overflow-scroll mx-2">
