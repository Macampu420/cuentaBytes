...
router.post('/reportesProductos/:tiempo', async (req, res, next) => {
  try {
    if (req.params.tiempo === 'horas') {
      ...
      const queryTotal = `CALL productosFacturasHoras('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryMejores = `CALL mejoresProductosFacturasHoras('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryPeores = `CALL peoresProductosFacturasHoras('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryRentabilidad = `CALL productosRentabilidadHoras('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryMejorRentabilidad = `CALL productosMayorRentabilidadHora('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryPeorRentabilidad = `CALL productosMenorRentabilidadHora('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryExistencia = 'CALL productoExistencia()'
      const queryMayorExistencia = 'CALL productoExistenciaMayor()'
      const queryMenorExistencia = 'CALL productoExistenciaMenor()'
      ...
      const queryTotal = `CALL productosFacturasDias('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryMejores = `CALL mejoresProductosFacturasDias('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryPeores = `CALL peoresProductosFacturasDias('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryRentabilidad = `CALL productosRentabilidadDias('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryMejorRentabilidad = `CALL productosMayorRentabilidadDia('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryPeorRentabilidad = `CALL productosMenorRentabilidadDia('${inicio} 00:00:00', '${fin} 23:59:59')`
      const queryExistencia = 'CALL productoExistencia()'
      const queryMayorExistencia = 'CALL productoExistenciaMayor()'
      const queryMenorExistencia = 'CALL productoExistenciaMenor()'
